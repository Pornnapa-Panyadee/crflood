...
void SendData_ultra(JsonObject& data){
  ...
  String URL = "http://www.crflood.com/crflood/get_data/cr.php?";
  String field1 = "M=" + data["id"].as<String>();
  //String field2 = "&B=" + data["analog"][2].as<String>();
  String field2 = "&B=12";
  String field3 = "&H=" + data["bme"][3].as<String>();
  String field4 = "&R=" + data["rain"].as<String>();
  String field5 = "&T=" + data["bme"][0].as<String>();
  String field6 = "&U=" + data["analog"][1].as<String>();
  String SendData_string = URL + field1 + field2 + field3 + field4 + field5 + field6;
